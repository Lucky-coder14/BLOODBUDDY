        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(bloodGroup.equals("Select your blood group")){
                    Toast.makeText(DonorRegisterationActivity.this, "Select your blood group",Toast.LENGTH_SHORT).show();
                    return;
                }
                else{
                   ...
                   mAuth.createUserWithEmailAndPassword(email , password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                       ...
                       public void onComplete(@NonNull Task<AuthResult> task) {
                           if(!task.isSuccessful()){
                               ...
                               Toast.makeText(DonorRegisterationActivity.this, "Error" + error , Toast.LENGTH_SHORT).show();
                               ...
                               userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                   ...
                                   public void onComplete(@NonNull Task task) {
                                       if(task.isSuccessful()){
                                           Toast.makeText(DonorRegisterationActivity.this, "Data set successfully", Toast.LENGTH_SHORT).show();

                                       }
                                       else{
                                           Toast.makeText(DonorRegisterationActivity.this, task.getException().toString(),Toast.LENGTH_SHORT).show();
                                       }
                                       finish();
                                     //  loader.dismiss();
                                   }
                             ...
                             if(resultUri !=null){
                                 ...
                                 uploadTask.addOnFailureListener(new OnFailureListener() {
                                     ...
                                     public void onFailure(@NonNull Exception e) {
                                         Toast.makeText(DonorRegisterationActivity.this, "Image upload failed",Toast.LENGTH_SHORT).show();
                                             ...
                                             result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                 ...
                                                 public void onSuccess(Uri uri) {
                                                     ...
                                                     userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                         ...
                                                         public void onComplete(@NonNull Task task) {
                                                          if(task.isSuccessful()){
                                                              Toast.makeText(DonorRegisterationActivity.this,"Image url added to database successfully",Toast.LENGTH_SHORT).show();
                                 ...
                                 Intent intent = new Intent(DonorRegisterationActivity.this, MainActivity.class);
                                 startActivity(intent);
                                 finish();
                                 loader.dismiss();
